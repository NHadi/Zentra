...
CREATE TABLE public.orders (
    ...
    CONSTRAINT valid_order_status CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('confirmed'::character varying)::text, ('in_production'::character varying)::text, ('completed'::character varying)::text, ('cancelled'::character varying)::text]))),
...
COPY public.orders (id, order_number, office_id, subtotal, discount_amount, total_amount, status, payment_status, expected_delivery_date, notes, tenant_id, created_at, created_by, updated_at, updated_by, customer_id) FROM stdin;
3	ORD-2024-001	17	1749.65	137.47	1612.18	in_production	partial	2025-04-08	Team order for new season	1	2025-04-01 10:27:52.945804+00	system	2025-04-10 10:58:46.976996+00	admin	1
5	ORD-1745770071680-157	34	749.85	0.00	749.85	pending	unpaid	2025-04-27	test	1	2025-04-27 16:07:51.713615+00	admin	2025-04-27 16:07:51.713615+00	admin	2
6	ORD-1746572344723-985	34	59.99	0.00	59.99	pending	unpaid	2025-05-07	test	1	2025-05-06 22:59:04.747221+00	admin	2025-05-06 22:59:04.747221+00	admin	2
9	ORD-1746572943641-664	34	320.00	0.00	320.00	in_production	paid	2025-05-08	test	1	2025-05-06 23:09:03.65801+00	admin	2025-05-14 03:23:44.651504+00	admin	2
\.
...
SELECT pg_catalog.setval('public.audit_trail_id_seq', 176, true);
...
SELECT pg_catalog.setval('public.cash_flow_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.master_product_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.master_zone_id_seq', 41, true);
